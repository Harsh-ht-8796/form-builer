      ...
      <div className="w-full lg:w-1/2 flex md:items-center sm:justify-end md:justify-stretch p-8">
        <div className="w-full max-w-sm space-y-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-purple-600 hover:bg-purple-700 text-white py-2 px-4 rounded-md font-medium">
              Log in
            </Button>
            ...
            <div className="text-center text-sm text-gray-600 mt-4">
              ...
              <Link href="/auth1/signup" className="text-blue-600 hover:text-blue-800">
                Sign up now
              </Link>
            </div>
          </form>
