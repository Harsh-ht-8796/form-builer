...
export type PostApiV1FormsMutationError = ErrorType<void>;

/**
 * @summary Create a new form
 */
export const usePostApiV1Forms = <TError = ErrorType<void>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof postApiV1Forms>>,
      TError,
...
export type GetApiV1FormsIdQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiV1FormsId>>
>;
export type GetApiV1FormsIdQueryError = ErrorType<void>;
 ...
 * @summary Get Form by ID
 */
export const putApiV1FormsId = (id: string, form: Form) => {
  return customInstance<FormResponse>({
    url: `/api/v1/forms/${id}`,
    method: "PUT",
    headers: { "Content-Type": "application/json" },
...
export type PutApiV1FormsIdMutationResult = NonNullable<
  Awaited<ReturnType<typeof putApiV1FormsId>>
>;
export type PutApiV1FormsIdMutationBody = Form;
export type PutApiV1FormsIdMutationError = ErrorType<void>;
...
export type GetApiV1FormsSearchQueryResult = NonNullable<
  Awaited<ReturnType<typeof getApiV1FormsSearch>>
>;
export type GetApiV1FormsSearchQueryError = ErrorType<void>;
...
export type PostApiV1FormsUploadImagesIdMutationBody =
  PostApiV1FormsUploadImagesIdBody;
export type PostApiV1FormsUploadImagesIdMutationError = ErrorType<void>;
